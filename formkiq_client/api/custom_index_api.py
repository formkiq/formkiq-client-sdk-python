...
class CustomIndexApi:
    ...
    def delete_index(
        ...
        index_type: Annotated[StrictStr, Field(description="Index Type")],
        ...
        :type index_key: str
        :param index_type: Index Type (required)
        :type index_type: str
    ...
    def delete_index_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteIndicesResponse]:
        """delete_index
    ...
    def _delete_index_serialize(
        ...
        if index_type is not None:
            _path_params['indexType'] = index_type
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/indices/{indexType}/{indexKey}',
    ...
    @validate_call
    def index_folder_move(
        self,
        index_type: Annotated[StrictStr, Field(description="Index Type")],
        index_folder_move_request: IndexFolderMoveRequest,
        site_id: Annotated[Optional[StrictStr], Field(description="Site Identifier")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param index_type: Index Type (required)
        :type index_type: str
        :param index_folder_move_request: (required)
        :type index_folder_move_request: IndexFolderMoveRequest
        :param site_id: Site Identifier
        :type site_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._index_folder_move_serialize(
            index_type=index_type,
            index_folder_move_request=index_folder_move_request,
            site_id=site_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def index_folder_move_with_http_info(
        self,
        index_type: Annotated[StrictStr, Field(description="Index Type")],
        index_folder_move_request: IndexFolderMoveRequest,
        site_id: Annotated[Optional[StrictStr], Field(description="Site Identifier")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IndexFolderMoveResponse]:
        """index_folder_move
    ...
    @validate_call
    def index_folder_move_without_preload_content(
        self,
        index_type: Annotated[StrictStr, Field(description="Index Type")],
        index_folder_move_request: IndexFolderMoveRequest,
        site_id: Annotated[Optional[StrictStr], Field(description="Site Identifier")] = None,
    ...
    def _index_folder_move_serialize(
        self,
        index_type,
        index_folder_move_request,
        site_id,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if index_folder_move_request is not None:
            _body_params = index_folder_move_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/indices/{indexType}/move',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def index_search(
        self,
        index_search_request: IndexSearchRequest,
        site_id: Annotated[Optional[StrictStr], Field(description="Site Identifier")] = None,
        ...
        :param index_search_request: (required)
        :type index_search_request: IndexSearchRequest
        :param site_id: Site Identifier
        :type site_id: str
        ...
        _param = self._index_search_serialize(
    ...
    @validate_call
    def index_search_with_http_info(
        self,
        index_search_request: IndexSearchRequest,
        site_id: Annotated[Optional[StrictStr], Field(description="Site Identifier")] = None,
        limit: Annotated[Optional[StrictStr], Field(description="Limit Results")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IndexSearchResponse]:
        """index_search
    ...
    @validate_call
    def index_search_without_preload_content(
        self,
        index_search_request: IndexSearchRequest,
        site_id: Annotated[Optional[StrictStr], Field(description="Site Identifier")] = None,
        limit: Annotated[Optional[StrictStr], Field(description="Limit Results")] = None,
    ...
    def _index_search_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if index_search_request is not None:
            _body_params = index_search_request
