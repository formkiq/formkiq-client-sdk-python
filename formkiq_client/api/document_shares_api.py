...
class DocumentSharesApi:
    ...
    def add_folder_share(
        ...
        add_folder_share_request: AddFolderShareRequest,
        ...
        :type index_key: str
        :param add_folder_share_request: (required)
        :type add_folder_share_request: AddFolderShareRequest
        ...
        _param = self._add_folder_share_serialize(
            index_key=index_key,
            add_folder_share_request=add_folder_share_request,
            site_id=site_id,
    ...
    @validate_call
    def add_folder_share_with_http_info(
        self,
        index_key: Annotated[StrictStr, Field(description="Index Key Identifier")],
        add_folder_share_request: AddFolderShareRequest,
        site_id: Annotated[Optional[StrictStr], Field(description="Site Identifier")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddFolderShareResponse]:
        """Add folder share
    ...
    @validate_call
    def add_folder_share_without_preload_content(
        self,
        index_key: Annotated[StrictStr, Field(description="Index Key Identifier")],
        add_folder_share_request: AddFolderShareRequest,
        site_id: Annotated[Optional[StrictStr], Field(description="Site Identifier")] = None,
    ...
    def _add_folder_share_serialize(
        self,
        index_key,
        add_folder_share_request,
        site_id,
        _request_auth,
        _content_type,
        _headers,
        ...
        if add_folder_share_request is not None:
            _body_params = add_folder_share_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/shares/folders/{indexKey}',
    ...
    def delete_share(
        self,
        share_key: Annotated[StrictStr, Field(description="Share Identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param share_key: Share Identifier (required)
        :type share_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def delete_share_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteShareResponse]:
        """Delete folder share
    ...
    def _delete_share_serialize(
        ...
        if share_key is not None:
            _path_params['shareKey'] = share_key
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
    ...
    def get_user_shares(
        self,
        group: Annotated[Optional[StrictStr], Field(description="Group Identifier")] = None,
        ...
        _param = self._get_user_shares_serialize(
            group=group,
            limit=limit,
            next=next,
            _request_auth=_request_auth,
    ...
    def get_user_shares_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetUserSharesResponse]:
        """Get user shared folders
    ...
    @validate_call
    def get_user_shares_without_preload_content(
        self,
        group: Annotated[Optional[StrictStr], Field(description="Group Identifier")] = None,
        limit: Annotated[Optional[StrictStr], Field(description="Limit Results")] = None,
        next: Annotated[Optional[StrictStr], Field(description="Next page of results token")] = None,
    ...
    def _get_user_shares_serialize(
        self,
        group,
        limit,
        next,
