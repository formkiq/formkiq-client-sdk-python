...
class DocumentVersionsApi:
    ...
    def delete_document_version(
        ...
        version_key: Annotated[StrictStr, Field(description="Version Key (version key required URL encoding)")],
        ...
        :param version_key: Version Key (version key required URL encoding) (required)
    ...
    def _delete_document_version_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/documents/{documentId}/versions/{versionKey}',
    ...
    def get_document_versions(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetDocumentVersionsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def get_document_versions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDocumentVersionsResponse]:
        """Get document's versions
    ...
    def _get_document_versions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/documents/{documentId}/versions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def set_document_version(
        ...
        :param document_id: Document Identifier (required)
        :type document_id: str
        :param set_document_version_request: (required)
        :type set_document_version_request: SetDocumentVersionRequest
        :param site_id: Site Identifier
        :type site_id: str
        :param artifact_id: Artifact Document Identifier
        :type artifact_id: str
        ...
        _param = self._set_document_version_serialize(
            document_id=document_id,
            set_document_version_request=set_document_version_request,
            site_id=site_id,
            artifact_id=artifact_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SetDocumentVersionResponse",
    ...
    @validate_call
    def set_document_version_with_http_info(
        self,
        document_id: Annotated[StrictStr, Field(description="Document Identifier")],
        set_document_version_request: SetDocumentVersionRequest,
        site_id: Annotated[Optional[StrictStr], Field(description="Site Identifier")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SetDocumentVersionResponse]:
        """Set version of document
    ...
    @validate_call
    def set_document_version_without_preload_content(
        self,
        document_id: Annotated[StrictStr, Field(description="Document Identifier")],
        set_document_version_request: SetDocumentVersionRequest,
        site_id: Annotated[Optional[StrictStr], Field(description="Site Identifier")] = None,
    ...
    def _set_document_version_serialize(
        self,
        document_id,
        set_document_version_request,
        site_id,
        artifact_id,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if set_document_version_request is not None:
            _body_params = set_document_version_request
