...
class DocumentWorkflowsApi:
    ...
    def set_workflow(
        ...
        site_id: Annotated[Optional[StrictStr], Field(description="Site Identifier")] = None,
        create_if_missing: Annotated[Optional[StrictBool], Field(description="When true, skip checking whether the resource exists before setting it")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param site_id: Site Identifier
        :type site_id: str
        :param create_if_missing: When true, skip checking whether the resource exists before setting it
    ...
    def _set_workflow_serialize(
        ...
        if create_if_missing is not None:
            ...
            _query_params.append(('createIfMissing', create_if_missing))
