...
class AddDocumentMetadata(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "value", "values", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "value", "values", ], str]):
