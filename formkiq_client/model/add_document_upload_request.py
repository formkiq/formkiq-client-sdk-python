...
class AddDocumentUploadRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tagSchemaId", "path", "tags", "actions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tagSchemaId", "path", "tags", "actions", ], str]):
