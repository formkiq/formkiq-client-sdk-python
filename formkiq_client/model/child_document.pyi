...
class ChildDocument(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["documentId", "path", "insertedDate", "lastModifiedDate", "checksum", "contentType", "userId", "contentLength", "versionId", "belongsToDocumentId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["documentId", "path", "insertedDate", "lastModifiedDate", "checksum", "contentType", "userId", "contentLength", "versionId", "belongsToDocumentId", ], str]):
