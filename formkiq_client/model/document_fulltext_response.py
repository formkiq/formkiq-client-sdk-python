...
class DocumentFulltextResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class documents(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FulltextSearchItem']:
                        return FulltextSearchItem
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FulltextSearchItem'], typing.List['FulltextSearchItem']],
                ...
                def __getitem__(self, i: int) -> 'FulltextSearchItem':
