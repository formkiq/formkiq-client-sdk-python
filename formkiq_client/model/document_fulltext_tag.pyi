...
class DocumentFulltextTag(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "eq", "eqOr", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "eq", "eqOr", ], str]):
