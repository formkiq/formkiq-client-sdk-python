...
class DocumentItemVersion(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["versionKey"]) -> MetaOapg.properties.versionKey: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["path", "insertedDate", "lastModifiedDate", "checksum", "documentId", "contentType", "userId", "contentLength", "versionId", "versionKey", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["versionKey"]) -> typing.Union[MetaOapg.properties.versionKey, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["path", "insertedDate", "lastModifiedDate", "checksum", "documentId", "contentType", "userId", "contentLength", "versionId", "versionKey", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        versionKey: typing.Union[MetaOapg.properties.versionKey, str, schemas.Unset] = schemas.unset,
