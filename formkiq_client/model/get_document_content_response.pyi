...
class GetDocumentContentResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["content", "contentUrl", "contentType", "isBase64", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["content", "contentUrl", "contentType", "isBase64", ], str]):
