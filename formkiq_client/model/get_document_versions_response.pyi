...
class GetDocumentVersionsResponse(
        ...
        class properties:
            ...
            class versions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DocumentItemVersion']:
                        return DocumentItemVersion
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DocumentItemVersion'], typing.List['DocumentItemVersion']],
                ...
                def __getitem__(self, i: int) -> 'DocumentItemVersion':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["next", "versions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["next", "versions", ], str]):
