        ...
        class properties:
            ...
            class tags(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WebhookTag']:
                        return WebhookTag
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['WebhookTag'], typing.List['WebhookTag']],
                ...
                def __getitem__(self, i: int) -> 'WebhookTag':
