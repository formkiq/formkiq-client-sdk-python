...
class IndexSearchResponse(
        ...
        class properties:
            ...
            class values(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['IndexSearch']:
                        return IndexSearch
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['IndexSearch'], typing.List['IndexSearch']],
                ...
                def __getitem__(self, i: int) -> 'IndexSearch':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["next", "previous", "values", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["next", "previous", "values", ], str]):
