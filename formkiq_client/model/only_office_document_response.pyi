...
class OnlyOfficeDocumentResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def config() -> typing.Type['OnlyOfficeConfig']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["config"]) -> 'OnlyOfficeConfig': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["config"]) -> typing.Union['OnlyOfficeConfig', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        config: typing.Union['OnlyOfficeConfig', schemas.Unset] = schemas.unset,
