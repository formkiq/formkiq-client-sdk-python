...
class UpdateMatchingDocumentTagsRequest(
    schemas.DictSchema
):
            ...
            class match(
                ...
                class MetaOapg:
                    ...
                    class properties:
                        ...
                        @staticmethod
                        def tag() -> typing.Type['MatchDocumentTag']:
                            return MatchDocumentTag
                        __annotations__ = {
                            "tag": tag,
                        }
                
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["tag"]) -> 'MatchDocumentTag': ...
                ...
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["tag"]) -> typing.Union['MatchDocumentTag', schemas.Unset]: ...
                ...
                def __new__(
                    ...
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    tag: typing.Union['MatchDocumentTag', schemas.Unset] = schemas.unset,
    ...
    update: MetaOapg.properties.update
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["match", "update", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["update"]) -> MetaOapg.properties.update: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["match", "update", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        match: typing.Union[MetaOapg.properties.match, dict, frozendict.frozendict, ],
        update: typing.Union[MetaOapg.properties.update, dict, frozendict.frozendict, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
