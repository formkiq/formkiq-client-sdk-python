...
class WebhookTag(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["value", "key", "insertedDate", "webhookId", "type", "userId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["value", "key", "insertedDate", "webhookId", "type", "userId", ], str]):
