...
class AddActionParameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ocrParseTypes", "ocrEngine", "addPdfDetectedCharactersAsText", "url", "characterMax", "engine", "notificationType", "notificationToCc", "notificationToBcc", "notificationSubject", "notificationText", "notificationHtml", "tags"]
