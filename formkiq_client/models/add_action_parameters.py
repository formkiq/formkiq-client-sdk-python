...
class AddActionParameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ocrParseTypes", "ocrEngine", "ocrOutputType", "ocrNumberOfPages", "addPdfDetectedCharactersAsText", "url", "characterMax", "engine", "notificationType", "notificationToCc", "notificationToBcc", "notificationSubject", "notificationText", "notificationHtml", "tags", "mappingId"]
