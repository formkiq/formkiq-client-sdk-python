...
class AddActionParameters(BaseModel):
    ...
    llm_prompt_entity_name: Optional[StrictStr] = Field(default=None, description="LLMPROMPT, DATA_CLASSIFICATION, METADATA_EXTRACTION: Set the LLM Prompt Entity Name", alias="llmPromptEntityName")
    model_id: Optional[StrictStr] = Field(default=None, description="LLMPROMPT: Override the LLM Prompt Entity model id", alias="modelId")
    ...
    path: Optional[StrictStr] = Field(default=None, description="MOVE: Destination folder path, must end with '/'; RESIZE: Path to use when creating resized document (optional)")
    delete_type: Optional[DeleteType] = Field(default=None, alias="deleteType")
    output_type: Optional[StrictStr] = Field(default=None, description="The output type of the image", alias="outputType")
    __properties: ClassVar[List[str]] = ["ocrTextractQueries", "ocrParseTypes", "ocrEngine", "ocrOutputType", "ocrNumberOfPages", "addPdfDetectedCharactersAsText", "llmPromptEntityName", "modelId", "url", "characterMax", "engine", "notificationType", "notificationToCc", "notificationToBcc", "notificationSubject", "notificationText", "notificationHtml", "tags", "mappingId", "eventBusName", "checksumType", "width", "height", "path", "deleteType", "outputType"]
