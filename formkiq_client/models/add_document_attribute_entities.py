...
class AddDocumentAttributeEntities(BaseModel):
    """
    Document Entity Attribute with multiple values
    """ # noqa: E501
    key: StrictStr = Field(description="Attribute key")
    entities: List[AddDocumentAttributeEntityValue] = Field(description="Attribute with entity values")
    __properties: ClassVar[List[str]] = ["key", "entities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "entities": [AddDocumentAttributeEntityValue.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None
        })
        return _obj
