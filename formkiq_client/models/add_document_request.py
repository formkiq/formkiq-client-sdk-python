...
class AddDocumentRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "tags": [AddDocumentTag.from_dict(_item) for _item in obj.get("tags")] if obj.get("tags") is not None else None,
            "metadata": [AddDocumentMetadata.from_dict(_item) for _item in obj.get("metadata")] if obj.get("metadata") is not None else None,
            "actions": [AddAction.from_dict(_item) for _item in obj.get("actions")] if obj.get("actions") is not None else None,
            "documents": [AddChildDocument.from_dict(_item) for _item in obj.get("documents")] if obj.get("documents") is not None else None
        })
        return _obj
