...
class AddDocumentRequest(BaseModel):
    ...
    artifacts: Optional[StrictBool] = Field(default=None, description="Whether the document supports artifact documents")
    ...
    __properties: ClassVar[List[str]] = ["documentId", "artifacts", "artifactCategory", "path", "checksumType", "checksum", "width", "height", "deepLinkPath", "contentType", "isBase64", "content", "tags", "metadata", "actions", "attributes", "documents"]
