...
class AddDocumentRequest(BaseModel):
    ...
    access_attributes: Optional[List[AddAccessAttribute]] = Field(default=None, description="List of Access Attributes (only available in pro/enterprise)", alias="accessAttributes")
    documents: Optional[List[AddChildDocument]] = Field(default=None, description="List of child documents")
    __properties: ClassVar[List[str]] = ["tagSchemaId", "path", "deepLinkPath", "contentType", "isBase64", "content", "tags", "metadata", "actions", "accessAttributes", "documents"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in access_attributes (list)
        _items = []
        if self.access_attributes:
            for _item in self.access_attributes:
                if _item:
                    _items.append(_item.to_dict())
            _dict['accessAttributes'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accessAttributes": [AddAccessAttribute.from_dict(_item) for _item in obj["accessAttributes"]] if obj.get("accessAttributes") is not None else None,
