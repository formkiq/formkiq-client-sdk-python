...
class AddDocumentResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["documentId", "siteId", "uploadUrl", "documents"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "documents": [AddChildDocumentResponse.from_dict(_item) for _item in obj.get("documents")] if obj.get("documents") is not None else None
        })
        return _obj
