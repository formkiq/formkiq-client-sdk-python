...
class AddDocumentReviewDecisionRequest(BaseModel):
    """
    AddDocumentReviewDecisionRequest
    """ # noqa: E501
    decision: AddDocumentReviewDecision
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "decision": AddDocumentReviewDecision.from_dict(obj["decision"]) if obj.get("decision") is not None else None
        })
        return _obj
