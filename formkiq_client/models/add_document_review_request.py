...
class AddDocumentReviewRequest(BaseModel):
    """
    AddDocumentReviewRequest
    """ # noqa: E501
    review: Optional[AddDocumentReview] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "review": AddDocumentReview.from_dict(obj["review"]) if obj.get("review") is not None else None
        })
        return _obj
