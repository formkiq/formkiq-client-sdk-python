...
class AddDocumentWorkflowDecisionsRequest(BaseModel):
    """
    ...
    comments: Optional[StrictStr] = Field(default=None, description="Workflow decision comments")
    decision: StrictStr
    __properties: ClassVar[List[str]] = ["stepId", "comments", "decision"]
