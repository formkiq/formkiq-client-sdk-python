...
class AddLocaleResourceItemResponse(BaseModel):
    """
    AddLocaleResourceItemResponse
    """ # noqa: E501
    item_key: Optional[StrictStr] = Field(default=None, description="Item Key of resource", alias="itemKey")
    __properties: ClassVar[List[str]] = ["itemKey"]
