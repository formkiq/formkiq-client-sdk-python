...
class AddTagSchemaRequest(BaseModel):
    """
    AddTagSchemaRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    tags: Optional[AddTagSchemaTags] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "tags": AddTagSchemaTags.from_dict(obj.get("tags")) if obj.get("tags") is not None else None
        })
        return _obj
