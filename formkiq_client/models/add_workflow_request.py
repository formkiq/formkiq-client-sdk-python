...
class AddWorkflowRequest(BaseModel):
    ...
    status: StrictStr
    steps: List[AddWorkflowStep] = Field(description="Workflow Steps")
    __properties: ClassVar[List[str]] = ["name", "description", "status", "steps"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "steps": [AddWorkflowStep.from_dict(_item) for _item in obj.get("steps")] if obj.get("steps") is not None else None
        })
        return _obj
