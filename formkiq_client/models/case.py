...
class Case(BaseModel):
    ...
    Case
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="Case Identifier", alias="caseId")
    case_number: Optional[StrictStr] = Field(default=None, description="Case Number", alias="caseNumber")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Case Name")
    ...
    __properties: ClassVar[List[str]] = ["caseId", "caseNumber", "documentNumber", "plannedStartDate", "startDate", "endDate", "dueDate", "insertedDate", "name", "description", "metadata", "status", "userId"]
