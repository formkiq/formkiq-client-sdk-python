...
class ChildDocument(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["path", "deepLinkPath", "insertedDate", "lastModifiedDate", "checksum", "documentId", "contentType", "userId", "contentLength", "versionId", "belongsToDocumentId"]
