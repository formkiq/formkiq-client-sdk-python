...
class CleanupOpenSearchSnapshotRepositoryResponse(BaseModel):
    """
    CleanupOpenSearchSnapshotRepositoryResponse
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="The OpenSearch cleanup snapshot repository response.")
