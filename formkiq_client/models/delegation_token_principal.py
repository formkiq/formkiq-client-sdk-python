...
class DelegationTokenPrincipal(BaseModel):
    """
    User identity to store in the signed delegation token.
    """ # noqa: E501
    username: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="Username to use for activity/audit attribution when the delegation token is applied.")
