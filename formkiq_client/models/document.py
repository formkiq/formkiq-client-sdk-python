...
class Document(BaseModel):
    ...
    deleted_date: Optional[StrictStr] = Field(default=None, description="Soft Deleted Timestamp", alias="deletedDate")
    ...
    __properties: ClassVar[List[str]] = ["siteId", "path", "width", "height", "deepLinkPath", "insertedDate", "lastModifiedDate", "deletedDate", "checksum", "checksumType", "documentId", "artifactId", "promotedArtifactId", "artifactCategory", "hasArtifacts", "contentType", "userId", "contentLength", "version", "versionKey", "s3version", "belongsToDocumentId", "metadata"]
