...
class Document(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["siteId", "path", "deepLinkPath", "insertedDate", "lastModifiedDate", "checksum", "documentId", "contentType", "userId", "contentLength", "version", "versionKey", "s3version", "belongsToDocumentId", "metadata"]
