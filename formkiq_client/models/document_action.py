...
class DocumentAction(BaseModel):
    ...
    DocumentAction
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status of the Document Action")
    type: Optional[StrictStr] = Field(default=None, description="Type of Document Action")
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('COMPLETE', 'FAILED', 'IN_QUEUE', 'PENDING', 'RUNNING', 'SKIPPED', 'FAILED_RETRY'):
            raise ValueError("must be one of enum values ('COMPLETE', 'FAILED', 'IN_QUEUE', 'PENDING', 'RUNNING', 'SKIPPED', 'FAILED_RETRY')")
        return value
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('ANTIVIRUS', 'DOCUMENTTAGGING', 'FULLTEXT', 'NOTIFICATION', 'OCR', 'QUEUE', 'WEBHOOK'):
            raise ValueError("must be one of enum values ('ANTIVIRUS', 'DOCUMENTTAGGING', 'FULLTEXT', 'NOTIFICATION', 'OCR', 'QUEUE', 'WEBHOOK')")
        return value
