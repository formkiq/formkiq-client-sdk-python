...
class DocumentSearch(BaseModel):
    ...
    tags: Optional[List[DocumentCompositeSearchTag]] = Field(default=None, description="List of Composite Key tags to filter search results on")
    ...
    __properties: ClassVar[List[str]] = ["text", "meta", "tag", "tags", "documentIds"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "meta": DocumentSearchMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "tag": DocumentSearchTag.from_dict(obj.get("tag")) if obj.get("tag") is not None else None,
            "tags": [DocumentCompositeSearchTag.from_dict(_item) for _item in obj.get("tags")] if obj.get("tags") is not None else None,
