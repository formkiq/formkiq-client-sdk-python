...
class DocumentSearch(BaseModel):
    ...
    filename: Optional[DocumentSearchFilename] = None
    folder: Optional[DocumentSearchFolder] = None
    ...
    __properties: ClassVar[List[str]] = ["text", "meta", "filename", "folder", "attribute", "attributes", "tag", "tags", "documentIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filename": DocumentSearchFilename.from_dict(obj["filename"]) if obj.get("filename") is not None else None,
            "folder": DocumentSearchFolder.from_dict(obj["folder"]) if obj.get("folder") is not None else None,
