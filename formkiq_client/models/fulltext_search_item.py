...
class FulltextSearchItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["siteId", "path", "deepLinkPath", "insertedDate", "lastModifiedDate", "documentId", "contentLength", "createdBy", "tags", "metadata", "accessAttributes"]
