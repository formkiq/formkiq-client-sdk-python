...
class GetActivitesResponse(BaseModel):
    """
    GetActivitesResponse
    """ # noqa: E501
    next: Optional[StrictStr] = Field(default=None, description="Next page of results token")
    activities: Optional[List[Activity]] = Field(default=None, description="List of Entity Type activities")
    __properties: ClassVar[List[str]] = ["next", "activities"]
