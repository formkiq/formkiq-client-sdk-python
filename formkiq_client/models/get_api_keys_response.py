...
class GetApiKeysResponse(BaseModel):
    ...
    GetApiKeysResponse
    """ # noqa: E501
    api_keys: Optional[List[ApiKey]] = Field(default=None, description="List of ApiKeys", alias="apiKeys")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "apiKeys": [ApiKey.from_dict(_item) for _item in obj.get("apiKeys")] if obj.get("apiKeys") is not None else None
        })
        return _obj
