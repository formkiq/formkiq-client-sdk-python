...
class GetDocumentAttributeVersionsResponse(BaseModel):
    """
    GetDocumentAttributeVersionsResponse
    """ # noqa: E501
    next: Optional[StrictStr] = Field(default=None, description="Next page of results token")
    attributes: Optional[List[DocumentAttribute]] = Field(default=None, description="List of document attribute versions")
