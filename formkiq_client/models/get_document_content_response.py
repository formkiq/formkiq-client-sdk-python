...
class GetDocumentContentResponse(BaseModel):
    ...
    content_url: Optional[StrictStr] = Field(default=None, description="URL to retrieve document content", alias="contentUrl")
    ...
    __properties: ClassVar[List[str]] = ["content", "contentUrl", "contentType", "isBase64"]
