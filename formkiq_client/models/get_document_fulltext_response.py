...
class GetDocumentFulltextResponse(BaseModel):
    ...
    access_attributes: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, alias="accessAttributes")
    __properties: ClassVar[List[str]] = ["siteId", "content", "contentType", "path", "deepLinkPath", "insertedDate", "lastModifiedDate", "documentId", "createdBy", "contentLength", "tags", "metadata", "accessAttributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accessAttributes": obj.get("accessAttributes")
        })
        return _obj
