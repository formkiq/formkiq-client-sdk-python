...
class GetDocumentResponse(BaseModel):
    ...
    artifact_category: Optional[StrictStr] = Field(default=None, description="Artifact Category", alias="artifactCategory")
    ...
    __properties: ClassVar[List[str]] = ["artifactId", "promotedArtifactId", "artifactCategory", "hasArtifacts", "siteId", "path", "width", "height", "deepLinkPath", "insertedDate", "lastModifiedDate", "checksum", "checksumType", "documentId", "contentType", "userId", "contentLength", "versionId", "documents", "belongsToDocumentId", "metadata"]
