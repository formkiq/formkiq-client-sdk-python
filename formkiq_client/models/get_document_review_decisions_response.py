...
class GetDocumentReviewDecisionsResponse(BaseModel):
    """
    GetDocumentReviewDecisionsResponse
    """ # noqa: E501
    next: Optional[StrictStr] = Field(default=None, description="Next page of results token")
    decisions: Optional[List[DocumentReviewDecision]] = Field(default=None, description="List of document review decisions")
    __properties: ClassVar[List[str]] = ["next", "decisions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "next": obj.get("next"),
            "decisions": [DocumentReviewDecision.from_dict(_item) for _item in obj["decisions"]] if obj.get("decisions") is not None else None
        })
        return _obj
