...
class GetDocumentReviewsResponse(BaseModel):
    """
    GetDocumentReviewsResponse
    """ # noqa: E501
    next: Optional[StrictStr] = Field(default=None, description="Next page of results token")
    reviews: Optional[List[DocumentReview]] = Field(default=None, description="List of document reviews")
    __properties: ClassVar[List[str]] = ["next", "reviews"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "next": obj.get("next"),
            "reviews": [DocumentReview.from_dict(_item) for _item in obj["reviews"]] if obj.get("reviews") is not None else None
        })
        return _obj
