...
class GetDocumentTagResponse(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="Tag type")
    user_id: Optional[StrictStr] = Field(default=None, description="User who added document", alias="userId")
    value: Optional[StrictStr] = Field(default=None, description="Tag value")
    values: Optional[List[StrictStr]] = Field(default=None, description="Tag values")
    key: Optional[StrictStr] = Field(default=None, description="Tag key")
    __properties: ClassVar[List[str]] = ["insertedDate", "documentId", "type", "userId", "value", "values", "key"]
