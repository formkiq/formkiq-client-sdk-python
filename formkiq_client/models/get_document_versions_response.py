...
class GetDocumentVersionsResponse(BaseModel):
    """
    GetDocumentVersionsResponse
    """ # noqa: E501
    next: Optional[StrictStr] = Field(default=None, description="Next page of results token")
    documents: Optional[List[DocumentVersion]] = Field(default=None, description="List of document versions")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "next": obj.get("next"),
            "documents": [DocumentVersion.from_dict(_item) for _item in obj.get("documents")] if obj.get("documents") is not None else None
        })
        return _obj
