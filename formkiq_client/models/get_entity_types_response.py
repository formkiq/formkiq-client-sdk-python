...
class GetEntityTypesResponse(BaseModel):
    ...
    entity_types: Optional[List[EntityType]] = Field(default=None, description="List of Entity Types", alias="entityTypes")
    __properties: ClassVar[List[str]] = ["next", "entityTypes"]
