...
class GetFolderPermissionsResponse(BaseModel):
    """
    GetFolderPermissionsResponse
    """ # noqa: E501
    roles: Optional[List[FolderPermission]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roles": [FolderPermission.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None
        })
        return _obj
