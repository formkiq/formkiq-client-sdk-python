...
class GetOpenSearchIndiceResponse(BaseModel):
    """
    GetOpenSearchIndiceResponse
    """ # noqa: E501
    indices: Optional[List[OpenSearchIndex]] = Field(default=None, description="OpenSearch Indices")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "indices": [OpenSearchIndex.from_dict(_item) for _item in obj["indices"]] if obj.get("indices") is not None else None
        })
        return _obj
