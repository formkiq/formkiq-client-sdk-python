...
class GetQueuesResponse(BaseModel):
    ...
    queues: Optional[List[Queue]] = Field(default=None, description="List of queues")
    __properties: ClassVar[List[str]] = ["next", "queues"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "next": obj.get("next"),
            "queues": [Queue.from_dict(_item) for _item in obj.get("queues")] if obj.get("queues") is not None else None
        })
        return _obj
