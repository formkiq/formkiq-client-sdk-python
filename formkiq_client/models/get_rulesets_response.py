...
class GetRulesetsResponse(BaseModel):
    """
    GetRulesetsResponse
    """ # noqa: E501
    next: Optional[StrictStr] = Field(default=None, description="Next page of results token")
    rulesets: Optional[List[Ruleset]] = Field(default=None, description="List of rulesets")
    __properties: ClassVar[List[str]] = ["next", "rulesets"]
