...
class GetTagSchemasResponse(BaseModel):
    """
    GetTagSchemasResponse
    """ # noqa: E501
    schemas: Optional[List[TagSchemaSummary]] = Field(default=None, description="List of Tag Schemas")
    next: Optional[StrictStr] = None
    previous: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["schemas", "next", "previous"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "schemas": [TagSchemaSummary.from_dict(_item) for _item in obj.get("schemas")] if obj.get("schemas") is not None else None,
            "next": obj.get("next"),
