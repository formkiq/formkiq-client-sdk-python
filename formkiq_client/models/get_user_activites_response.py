...
class GetUserActivitesResponse(BaseModel):
    """
    GetUserActivitesResponse
    """ # noqa: E501
    next: Optional[StrictStr] = Field(default=None, description="Next page of results token")
    user_activities: Optional[List[UserActivity]] = Field(default=None, description="List of user activities syncs", alias="userActivities")
    __properties: ClassVar[List[str]] = ["next", "userActivities"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "next": obj.get("next"),
            "userActivities": [UserActivity.from_dict(_item) for _item in obj.get("userActivities")] if obj.get("userActivities") is not None else None
        })
        return _obj
