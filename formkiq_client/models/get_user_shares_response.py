...
class GetUserSharesResponse(BaseModel):
    """
    GetUserSharesResponse
    """ # noqa: E501
    next: Optional[StrictStr] = Field(default=None, description="Next page of results token")
    shares: Optional[List[UserShare]] = Field(default=None, description="List of user's shares")
    __properties: ClassVar[List[str]] = ["next", "shares"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "next": obj.get("next"),
            "shares": [UserShare.from_dict(_item) for _item in obj.get("shares")] if obj.get("shares") is not None else None
        })
        return _obj
