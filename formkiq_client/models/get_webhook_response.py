...
class GetWebhookResponse(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Webhook name")
    ...
    enabled: Optional[StrictStr] = Field(default=None, description="Is webhook enabled")
    ttl: Optional[StrictStr] = Field(default=None, description="Webhook time to live (expiry in seconds)")
    __properties: ClassVar[List[str]] = ["siteId", "name", "url", "insertedDate", "webhookId", "userId", "enabled", "ttl"]
