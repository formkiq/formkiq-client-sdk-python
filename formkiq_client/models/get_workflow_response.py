...
class GetWorkflowResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "inUse", "status", "steps"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "steps": [WorkflowStep.from_dict(_item) for _item in obj.get("steps")] if obj.get("steps") is not None else None
        })
        return _obj
