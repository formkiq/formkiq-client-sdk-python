...
class OnlyOfficeConfig(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "editorConfig": OnlyOfficeEditorConfig.from_dict(obj["editorConfig"]) if obj.get("editorConfig") is not None else None,
            "document": OnlyOfficeConfigDocument.from_dict(obj["document"]) if obj.get("document") is not None else None
        })
        return _obj
