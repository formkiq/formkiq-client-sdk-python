...
class OnlyOfficeDocumentResponse(BaseModel):
    """
    OnlyOfficeDocumentResponse
    """ # noqa: E501
    config: Optional[OnlyOfficeConfig] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "config": OnlyOfficeConfig.from_dict(obj.get("config")) if obj.get("config") is not None else None
        })
        return _obj
