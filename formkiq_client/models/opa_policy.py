...
class OpaPolicy(BaseModel):
    ...
    OpaPolicy
    """ # noqa: E501
    site_id: Optional[StrictStr] = Field(default=None, description="SiteId to apply OPA Policy to", alias="siteId")
    ...
    __properties: ClassVar[List[str]] = ["siteId", "policy", "insertedDate"]
