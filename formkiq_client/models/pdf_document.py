...
class PdfDocument(BaseModel):
    ...
    PdfDocument
    """ # noqa: E501
    fields: Optional[List[PdfDocumentField]] = Field(default=None, description="List of document fields")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [PdfDocumentField.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
        return _obj
