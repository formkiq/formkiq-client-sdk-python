...
class RuleCondition(BaseModel):
    ...
    RuleCondition
    """ # noqa: E501
    must: Optional[List[RuleConditionMust]] = Field(default=None, description="List of rule conditions")
    __properties: ClassVar[List[str]] = ["must"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "must": [RuleConditionMust.from_dict(_item) for _item in obj["must"]] if obj.get("must") is not None else None
        })
        return _obj
