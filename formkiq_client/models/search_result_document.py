...
class SearchResultDocument(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["siteId", "path", "deepLinkPath", "insertedDate", "lastModifiedDate", "folder", "indexKey", "checksum", "checksumType", "documentId", "contentType", "userId", "contentLength", "versionId", "belongsToDocumentId", "matchedAttribute", "matchedTag", "matchedTags", "tags", "attributes", "metadata"]
