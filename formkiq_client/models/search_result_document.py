...
class SearchResultDocument(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["siteId", "path", "deepLinkPath", "insertedDate", "lastModifiedDate", "folder", "indexKey", "checksum", "documentId", "contentType", "userId", "contentLength", "versionId", "belongsToDocumentId", "matchedTag", "matchedTags", "tags", "metadata"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "matchedTag": DocumentSearchMatchTag.from_dict(obj.get("matchedTag")) if obj.get("matchedTag") is not None else None,
            "matchedTags": [DocumentSearchMatchTag.from_dict(_item) for _item in obj.get("matchedTags")] if obj.get("matchedTags") is not None else None,
            "tags": obj.get("tags"),
            "metadata": [DocumentMetadata.from_dict(_item) for _item in obj.get("metadata")] if obj.get("metadata") is not None else None
        })
        return _obj
