...
class SearchResultDocument(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["siteId", "path", "deepLinkPath", "insertedDate", "lastModifiedDate", "folder", "indexKey", "checksum", "documentId", "contentType", "userId", "contentLength", "versionId", "belongsToDocumentId", "matchedAttribute", "matchedTag", "matchedTags", "tags", "attributes", "metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.matched_tags:
            for _item in self.matched_tags:
                if _item:
