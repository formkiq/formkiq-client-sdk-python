...
class SetClassificationRequest(BaseModel):
    """
    SetClassificationRequest
    """ # noqa: E501
    classification: Optional[AddClassification] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "classification": AddClassification.from_dict(obj["classification"]) if obj.get("classification") is not None else None
        })
        return _obj
