...
class SetEntityTypeRequest(BaseModel):
    """
    SetEntityTypeRequest
    """ # noqa: E501
    entity_type: Optional[AddEntityType] = Field(default=None, alias="entityType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entityType": AddEntityType.from_dict(obj["entityType"]) if obj.get("entityType") is not None else None
        })
        return _obj
