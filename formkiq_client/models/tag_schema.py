...
class TagSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tagSchemaId", "name", "userId", "insertedDate", "tags"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "tags": TagSchemaTags.from_dict(obj.get("tags")) if obj.get("tags") is not None else None
        })
        return _obj
