...
class TagSchemaOptional(BaseModel):
    """
    TagSchemaOptional
    """ # noqa: E501
    key: Optional[StrictStr] = None
    default_values: Optional[List[StrictStr]] = Field(default=None, description="Default values", alias="defaultValues")
    allowed_values: Optional[List[StrictStr]] = Field(default=None, description="Only valid values", alias="allowedValues")
    __properties: ClassVar[List[str]] = ["key", "defaultValues", "allowedValues"]
