...
class UpdateConfigurationRequest(BaseModel):
    ...
    notification_email: Optional[StrictStr] = Field(default=None, description="Email address to use for notifications", alias="notificationEmail")
    ...
    __properties: ClassVar[List[str]] = ["chatGptApiKey", "maxContentLengthBytes", "maxDocuments", "maxWebhooks", "notificationEmail", "document", "ocr", "google", "docusign"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "document": DocumentConfig.from_dict(obj["document"]) if obj.get("document") is not None else None,
