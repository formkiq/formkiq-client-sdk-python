...
class UpdateDocumentRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["artifactCategory", "path", "width", "height", "deepLinkPath", "contentType", "isBase64", "content", "checksum", "checksumType", "tags", "metadata", "attributes", "actions", "documents"]
