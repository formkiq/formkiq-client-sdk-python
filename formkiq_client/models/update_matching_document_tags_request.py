...
class UpdateMatchingDocumentTagsRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "match": UpdateMatchingDocumentTagsRequestMatch.from_dict(obj.get("match")) if obj.get("match") is not None else None,
            "update": UpdateMatchingDocumentTagsRequestUpdate.from_dict(obj.get("update")) if obj.get("update") is not None else None
        })
        return _obj
