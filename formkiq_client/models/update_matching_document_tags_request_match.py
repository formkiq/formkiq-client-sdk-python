...
class UpdateMatchingDocumentTagsRequestMatch(BaseModel):
    """
    UpdateMatchingDocumentTagsRequestMatch
    """ # noqa: E501
    tag: Optional[MatchDocumentTag] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tag": MatchDocumentTag.from_dict(obj.get("tag")) if obj.get("tag") is not None else None
        })
        return _obj
