...
class UserActivity(BaseModel):
    ...
    UserActivity
    """ # noqa: E501
    activity_id: Optional[StrictStr] = Field(default=None, description="Activity identifier", alias="activityId")
    ...
    time_to_live: Optional[StrictStr] = Field(default=None, description="User activity time to live", alias="timeToLive")
    __properties: ClassVar[List[str]] = ["activityId", "type", "insertedDate", "userId", "versionKey", "timeToLive"]
