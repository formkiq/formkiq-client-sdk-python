...
class WorkflowStep(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "action": DocumentAction.from_dict(obj.get("action")) if obj.get("action") is not None else None,
            "queue": WorkflowQueue.from_dict(obj.get("queue")) if obj.get("queue") is not None else None,
            "decisions": [WorkflowStepDecision.from_dict(_item) for _item in obj.get("decisions")] if obj.get("decisions") is not None else None
        })
        return _obj
