...
class WorkflowStep(BaseModel):
    ...
    decisions: Optional[List[WorkflowStepDecisions]] = Field(default=None, description="Workflow Decisions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "decisions": [WorkflowStepDecisions.from_dict(_item) for _item in obj["decisions"]] if obj.get("decisions") is not None else None
        })
        return _obj
