...
class WorkflowStepConditionAttributeValueComparison(BaseModel):
    """
    ...
    """ # noqa: E501
    source_type: WorkflowStepConditionAttributeValueComparisonSourceType = Field(alias="sourceType")
    value_attribute_key: StrictStr = Field(description="Document attribute key containing the value to compare.", alias="valueAttributeKey")
    comparison: WorkflowStepConditionAttributeValueComparisonTarget
    __properties: ClassVar[List[str]] = ["sourceType", "valueAttributeKey", "comparison"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "valueAttributeKey": obj.get("valueAttributeKey"),
            "comparison": WorkflowStepConditionAttributeValueComparisonTarget.from_dict(obj["comparison"]) if obj.get("comparison") is not None else None
        })
        return _obj
