...
class WorkflowStepConditionAttributeValueComparisonAttribute(BaseModel):
    """
    Uses another document attribute value as the right-side comparison value. 
    """ # noqa: E501
    attribute_key: StrictStr = Field(description="Document attribute key containing the comparison value.", alias="attributeKey")
    __properties: ClassVar[List[str]] = ["attributeKey"]
