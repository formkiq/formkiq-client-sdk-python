...
# body param
SchemaForRequestBodyApplicationJson = SetConfigRequest


request_body_set_config_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SetConfigResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_config_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_set_config_request.serialize(body, content_type)
