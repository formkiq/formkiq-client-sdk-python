...
# body param
SchemaForRequestBodyApplicationJson = AddApiKeyRequest


request_body_add_api_key_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AddApiKeyResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_api_key_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_add_api_key_request.serialize(body, content_type)
