...
# body param
SchemaForRequestBodyApplicationJson = DocumentsCompressRequest


request_body_documents_compress_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = DocumentsCompressResponse
...
class BaseApi(api_client.Api):
    ...
    def _compress_documents_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_documents_compress_request.serialize(body, content_type)
...
class CompressDocuments(BaseApi):
    ...
    def compress_documents(
        ...
        return self._compress_documents_oapg(
            body=body,
