...
# body param
SchemaForRequestBodyApplicationJson = AddDocumentRequest


request_body_add_document_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AddDocumentResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_document_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_add_document_request.serialize(body, content_type)
