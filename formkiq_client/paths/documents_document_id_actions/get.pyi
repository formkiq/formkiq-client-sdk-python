...
SchemaFor200ResponseBodyApplicationJson = GetDocumentActionsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_document_actions_oapg(
        self,
...
class GetDocumentActions(BaseApi):
    ...
    def get_document_actions(
        ...
        return self._get_document_actions_oapg(
