...
SchemaFor200ResponseBodyApplicationJson = GetDocumentContentResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_document_content_oapg(
        self,
...
class GetDocumentContent(BaseApi):
    ...
    def get_document_content(
        ...
        return self._get_document_content_oapg(
