...
SchemaFor200ResponseBodyApplicationJson = DeleteFulltextResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_document_fulltext_oapg(
        self,
...
class DeleteDocumentFulltext(BaseApi):
    ...
    def delete_document_fulltext(
        ...
        return self._delete_document_fulltext_oapg(
