...
SchemaFor200ResponseBodyApplicationJson = GetDocumentFulltextResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_document_fulltext_oapg(
        self,
...
class GetDocumentFulltext(BaseApi):
    ...
    def get_document_fulltext(
        ...
        return self._get_document_fulltext_oapg(
