...
# body param
SchemaForRequestBodyApplicationJson = UpdateDocumentFulltextRequest


request_body_update_document_fulltext_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_document_fulltext_oapg(
        self,
    ...
    def _update_document_fulltext_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_update_document_fulltext_request.serialize(body, content_type)
...
class UpdateDocumentFulltext(BaseApi):
    ...
    def update_document_fulltext(
        ...
        return self._update_document_fulltext_oapg(
            body=body,
