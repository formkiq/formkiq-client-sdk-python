...
# body param
SchemaForRequestBodyApplicationJson = SetDocumentFulltextRequest


request_body_set_document_fulltext_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SetDocumentFulltextResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_document_fulltext_oapg(
        self,
    ...
    def _set_document_fulltext_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_set_document_fulltext_request.serialize(body, content_type)
...
class SetDocumentFulltext(BaseApi):
    ...
    def set_document_fulltext(
        ...
        return self._set_document_fulltext_oapg(
            body=body,
