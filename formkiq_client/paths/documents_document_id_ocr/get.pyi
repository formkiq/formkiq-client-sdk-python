...
ContentUrlSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'contentUrl': typing.Union[ContentUrlSchema, str, ],
...
request_query_content_url = api_client.QueryParameter(
    name="contentUrl",
    style=api_client.ParameterStyle.FORM,
    schema=ContentUrlSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = GetDocumentOcrResponse
...
class GetDocumentOcr(BaseApi):
    ...
    def get_document_ocr(
        ...
        return self._get_document_ocr_oapg(
