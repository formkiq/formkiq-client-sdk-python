...
# body param
SchemaForRequestBodyApplicationJson = AddDocumentOcrRequest


request_body_add_document_ocr_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_document_ocr_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_document_ocr_request.serialize(body, content_type)
...
class AddDocumentOcr(BaseApi):
    ...
    def add_document_ocr(
        ...
        return self._add_document_ocr_oapg(
            body=body,
