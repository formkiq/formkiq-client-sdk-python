...
# body param
SchemaForRequestBodyApplicationJson = SetDocumentOcrRequest


request_body_set_document_ocr_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AddDocumentOcrResponse
...
class BaseApi(api_client.Api):
    ...
    def _set_document_ocr_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_set_document_ocr_request.serialize(body, content_type)
...
class SetDocumentOcr(BaseApi):
    ...
    def set_document_ocr(
        ...
        return self._set_document_ocr_oapg(
            body=body,
