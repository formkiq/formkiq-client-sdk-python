...
SchemaFor200ResponseBodyApplicationJson = GetDocumentSyncResponse
...
class GetDocumentSyncs(BaseApi):
    ...
    def get_document_syncs(
        ...
        return self._get_document_syncs_oapg(
