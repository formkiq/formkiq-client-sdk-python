...
SchemaFor200ResponseBodyApplicationJson = GetDocumentTagsResponse
...
class GetDocumentTags(BaseApi):
    ...
    def get_document_tags(
        ...
        return self._get_document_tags_oapg(
