...
# body param
SchemaForRequestBodyApplicationJson = AddDocumentTagsRequest


request_body_add_document_tags_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_document_tags_oapg(
        self,
    ...
    def _update_document_tags_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_add_document_tags_request.serialize(body, content_type)
...
class UpdateDocumentTags(BaseApi):
    ...
    def update_document_tags(
        ...
        return self._update_document_tags_oapg(
            body=body,
