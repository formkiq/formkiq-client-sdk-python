...
SchemaFor200ResponseBodyApplicationJson = GetDocumentTagResponse
...
class GetDocumentTag(BaseApi):
    ...
    def get_document_tag(
        ...
        return self._get_document_tag_oapg(
