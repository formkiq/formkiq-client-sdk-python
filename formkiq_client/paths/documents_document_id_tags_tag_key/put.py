...
# body param
SchemaForRequestBodyApplicationJson = SetDocumentTagKeyRequest


request_body_set_document_tag_key_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_document_tag_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_set_document_tag_key_request.serialize(body, content_type)
...
class SetDocumentTag(BaseApi):
    ...
    def set_document_tag(
        ...
        return self._set_document_tag_oapg(
            body=body,
