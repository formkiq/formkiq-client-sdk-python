...
InlineSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'inline': typing.Union[InlineSchema, bool, ],
    },
    total=False
)
...
request_query_version_key = api_client.QueryParameter(
    name="versionKey",
    style=api_client.ParameterStyle.FORM,
...
request_query_inline = api_client.QueryParameter(
    name="inline",
    style=api_client.ParameterStyle.FORM,
    schema=InlineSchema,
    explode=True,
...
SchemaFor200ResponseBodyApplicationJson = GetDocumentUrlResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_document_url_oapg(
        ...
        for parameter in (
            ...
            request_query_version_key,
            request_query_duration,
            request_query_share_key,
            request_query_inline,
        ):
...
class GetDocumentUrl(BaseApi):
    ...
    def get_document_url(
        ...
        return self._get_document_url_oapg(
