...
SchemaFor200ResponseBodyApplicationJson = GetDocumentVersionsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_document_versions_oapg(
        self,
...
class GetDocumentVersions(BaseApi):
    ...
    def get_document_versions(
        ...
        return self._get_document_versions_oapg(
