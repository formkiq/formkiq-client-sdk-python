...
# body param
SchemaForRequestBodyApplicationJson = SetDocumentVersionRequest


request_body_set_document_version_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SetDocumentVersionResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_document_version_oapg(
        self,
    ...
    def _set_document_version_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_set_document_version_request.serialize(body, content_type)
...
class SetDocumentVersion(BaseApi):
    ...
    def set_document_version(
        ...
        return self._set_document_version_oapg(
            body=body,
