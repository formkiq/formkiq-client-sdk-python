...
# body param
SchemaForRequestBodyApplicationJson = UpdateMatchingDocumentTagsRequest


request_body_update_matching_document_tags_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UpdateMatchingDocumentTagsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_matching_document_tags_oapg(
        self,
    ...
    def _update_matching_document_tags_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_matching_document_tags_request.serialize(body, content_type)
...
class UpdateMatchingDocumentTags(BaseApi):
    ...
    def update_matching_document_tags(
        ...
        return self._update_matching_document_tags_oapg(
            body=body,
