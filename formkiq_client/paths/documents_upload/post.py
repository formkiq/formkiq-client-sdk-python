...
ShareKeySchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'contentLength': typing.Union[ContentLengthSchema, decimal.Decimal, int, ],
        'duration': typing.Union[DurationSchema, decimal.Decimal, int, ],
        'shareKey': typing.Union[ShareKeySchema, str, ],
    },
    total=False
)
...
request_query_content_length = api_client.QueryParameter(
    name="contentLength",
    style=api_client.ParameterStyle.FORM,
...
request_query_share_key = api_client.QueryParameter(
    name="shareKey",
    style=api_client.ParameterStyle.FORM,
    schema=ShareKeySchema,
    explode=True,
)
# body param
SchemaForRequestBodyApplicationJson = AddDocumentUploadRequest


request_body_add_document_upload_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = GetDocumentUrlResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_document_upload_oapg(
        ...
        for parameter in (
            ...
            request_query_content_length,
            request_query_duration,
            request_query_share_key,
        ):
        ...
        _fields = None
        _body = None
        serialized_data = request_body_add_document_upload_request.serialize(body, content_type)
...
class AddDocumentUpload(BaseApi):
    ...
    def add_document_upload(
        ...
        return self._add_document_upload_oapg(
            body=body,
