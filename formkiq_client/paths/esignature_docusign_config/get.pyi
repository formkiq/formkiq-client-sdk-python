...
SchemaFor200ResponseBodyApplicationJson = EsignatureDocusignConfigResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _esignature_docusign_config_oapg(
        self,
...
class EsignatureDocusignConfig(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def esignature_docusign_config(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def esignature_docusign_config(
        ...
        return self._esignature_docusign_config_oapg(
