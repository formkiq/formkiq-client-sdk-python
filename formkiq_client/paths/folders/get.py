...
request_query_index_key = api_client.QueryParameter(
    name="indexKey",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = GetFoldersResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_folder_documents_oapg(
        self,
...
class GetFolderDocuments(BaseApi):
    ...
    def get_folder_documents(
        ...
        return self._get_folder_documents_oapg(
