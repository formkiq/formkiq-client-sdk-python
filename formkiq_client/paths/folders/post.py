...
# body param
SchemaForRequestBodyApplicationJson = AddFolderRequest


request_body_add_folder_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = AddFolderResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_folder_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_add_folder_request.serialize(body, content_type)
