...
# Path params
IndexTypeSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'indexType': typing.Union[IndexTypeSchema, str, ],
    }
)
...
request_path_index_type = api_client.PathParameter(
    name="indexType",
...
# body param
SchemaForRequestBodyApplicationJson = IndexFolderMoveRequest


request_body_index_folder_move_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = IndexFolderMoveResponse
...
SchemaFor400ResponseBodyApplicationJson = ValidationErrorsResponse
...
class BaseApi(api_client.Api):
    ...
    def _index_folder_move_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_index_folder_move_request.serialize(body, content_type)
...
class IndexFolderMove(BaseApi):
    ...
    def index_folder_move(
        ...
        return self._index_folder_move_oapg(
            body=body,
