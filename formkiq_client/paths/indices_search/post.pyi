...
# body param
SchemaForRequestBodyApplicationJson = IndexSearchRequest


request_body_index_search_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = IndexSearchResponse
...
class BaseApi(api_client.Api):
    ...
    def _index_search_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_index_search_request.serialize(body, content_type)
