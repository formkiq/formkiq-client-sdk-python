...
SchemaFor200ResponseBodyApplicationJson = OnlyOfficeDocumentSaveResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _only_office_document_save_oapg(
        self,
...
class OnlyOfficeDocumentSave(BaseApi):
    ...
    def only_office_document_save(
        ...
        return self._only_office_document_save_oapg(
