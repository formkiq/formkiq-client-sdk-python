...
# body param
SchemaForRequestBodyApplicationJson = OnlyOfficeDocumentNewRequest


request_body_only_office_document_new_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OnlyOfficeDocumentResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _only_office_document_new_oapg(
        self,
    ...
    def _only_office_document_new_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_only_office_document_new_request.serialize(body, content_type)
...
class OnlyOfficeDocumentNew(BaseApi):
    ...
    def only_office_document_new(
        ...
        return self._only_office_document_new_oapg(
            body=body,
