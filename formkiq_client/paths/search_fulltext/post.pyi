...
# body param
SchemaForRequestBodyApplicationJson = DocumentFulltextRequest


request_body_document_fulltext_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = DocumentFulltextResponse
...
class BaseApi(api_client.Api):
    ...
    def _document_fulltext_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_document_fulltext_request.serialize(body, content_type)
...
class DocumentFulltext(BaseApi):
    ...
    def document_fulltext(
        ...
        return self._document_fulltext_oapg(
            body=body,
