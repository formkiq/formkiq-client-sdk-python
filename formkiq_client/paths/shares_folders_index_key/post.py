...
# Path params
IndexKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'indexKey': typing.Union[IndexKeySchema, str, ],
    }
)
...
request_path_index_key = api_client.PathParameter(
    name="indexKey",
...
# body param
SchemaForRequestBodyApplicationJson = AddFolderShareRequest


request_body_add_folder_share_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = AddFolderShareResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_folder_share_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_add_folder_share_request.serialize(body, content_type)
...
class AddFolderShare(BaseApi):
    ...
    def add_folder_share(
        ...
        return self._add_folder_share_oapg(
            body=body,
