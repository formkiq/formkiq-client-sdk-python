...
request_path_share_key = api_client.PathParameter(
    name="shareKey",
...
SchemaFor200ResponseBodyApplicationJson = DeleteShareResponse
...
class DeleteShare(BaseApi):
    ...
    def delete_share(
        ...
        return self._delete_share_oapg(
