...
# Path params
TagSchemaIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'tagSchemaId': typing.Union[TagSchemaIdSchema, str, ],
    }
)
...
request_path_tag_schema_id = api_client.PathParameter(
    name="tagSchemaId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TagSchemaIdSchema,
    required=True,
)
...
SchemaFor200ResponseBodyApplicationJson = GetTagSchemaRequest
...
class GetTagSchema(BaseApi):
    ...
    def get_tag_schema(
        ...
        return self._get_tag_schema_oapg(
