...
# body param
SchemaForRequestBodyApplicationJson = AddWebhookRequest


request_body_add_webhook_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = AddWebhookResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_webhook_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_add_webhook_request.serialize(body, content_type)
