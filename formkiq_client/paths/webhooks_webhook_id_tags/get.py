...
SchemaFor200ResponseBodyApplicationJson = GetWebhookTagsResponse
...
class GetWebhookTags(BaseApi):
    ...
    def get_webhook_tags(
        ...
        return self._get_webhook_tags_oapg(
