...
class DocumentAction(BaseModel):
    ...
    retry_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The number of times this action has already been attempted", alias="retryCount")
    max_retries: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The maximum number of retry attempts allowed for this action", alias="maxRetries")
    ...
    parameters: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="Action parameters")
    metadata: Optional[Dict[str, StrictStr]] = Field(default=None, description="Action metadata")
    __properties: ClassVar[List[str]] = ["status", "type", "retryCount", "maxRetries", "queueId", "workflowId", "workflowStepId", "message", "userId", "insertedDate", "startDate", "completedDate", "parameters", "metadata"]
