...
class FulltextSearchItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["siteId", "path", "contentType", "width", "height", "deepLinkPath", "insertedDate", "lastModifiedDate", "checksum", "checksumType", "documentId", "contentLength", "createdBy", "tags", "metadata", "attributes"]
