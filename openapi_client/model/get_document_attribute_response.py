...
class GetDocumentAttributeResponse(BaseModel):
    """
    GetDocumentAttributeResponse
    """ # noqa: E501
    attribute: Optional[DocumentAttribute] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attribute": DocumentAttribute.from_dict(obj["attribute"]) if obj.get("attribute") is not None else None
        })
        return _obj
