...
class GetLocalesResponse(BaseModel):
    """
    GetLocalesResponse
    """ # noqa: E501
    next: Optional[StrictStr] = Field(default=None, description="Next page of results token")
    locales: Optional[List[LocaleInfo]] = Field(default=None, description="List of Locale")
    __properties: ClassVar[List[str]] = ["next", "locales"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "next": obj.get("next"),
            "locales": [LocaleInfo.from_dict(_item) for _item in obj["locales"]] if obj.get("locales") is not None else None
        })
        return _obj
