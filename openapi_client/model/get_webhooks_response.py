...
class GetWebhooksResponse(BaseModel):
    ...
    webhooks: Optional[List[GetWebhookResponse]] = Field(default=None, description="List of webhooks")
    __properties: ClassVar[List[str]] = ["next", "webhooks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "next": obj.get("next"),
            "webhooks": [GetWebhookResponse.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None
        })
        return _obj
