...
class OpenSearchS3Repository(BaseModel):
    """
    OpenSearchS3Repository
    """ # noqa: E501
    repository: Optional[StrictStr] = Field(default=None, description="Name of the Repository")
    bucket: Optional[StrictStr] = Field(default=None, description="Name of the S3 bucket")
    __properties: ClassVar[List[str]] = ["repository", "bucket"]
