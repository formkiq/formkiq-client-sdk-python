...
class SetDocumentAttributeRequest(BaseModel):
    """
    Set List of document attributes
    """ # noqa: E501
    attribute: Optional[AddDocumentAttributeValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attribute": AddDocumentAttributeValue.from_dict(obj["attribute"]) if obj.get("attribute") is not None else None
        })
        return _obj
