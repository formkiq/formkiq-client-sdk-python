...
class SetDocumentFulltextRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["contentType", "content", "contentUrls", "path", "width", "height", "deepLinkPath", "checksum", "checksumType", "tags", "metadata", "attributes"]
