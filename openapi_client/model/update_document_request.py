...
class UpdateDocumentRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["path", "width", "height", "deepLinkPath", "contentType", "isBase64", "content", "checksum", "checksumType", "tags", "metadata", "attributes", "actions", "documents"]
