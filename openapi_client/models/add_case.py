...
class AddCase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "status", "plannedStartDate", "startDate", "endDate", "dueDate", "description", "documentNumberFormat", "caseNumberFormat", "metadata", "documentIds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.document_number_format:
            for _item_document_number_format in self.document_number_format:
                if _item_document_number_format:
                    _items.append(_item_document_number_format.to_dict())
        ...
        if self.case_number_format:
            for _item_case_number_format in self.case_number_format:
                if _item_case_number_format:
                    _items.append(_item_case_number_format.to_dict())
