...
class AddDocumentRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["documentId", "path", "checksumType", "checksum", "width", "height", "deepLinkPath", "contentType", "isBase64", "content", "tags", "metadata", "actions", "attributes", "documents"]
