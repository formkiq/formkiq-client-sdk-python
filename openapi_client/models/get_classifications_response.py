...
class GetClassificationsResponse(BaseModel):
    """
    GetClassificationsResponse
    """ # noqa: E501
    next: Optional[StrictStr] = Field(default=None, description="Next page of results token")
    classifications: Optional[List[ClassificationSummary]] = Field(default=None, description="List of classifications")
    __properties: ClassVar[List[str]] = ["next", "classifications"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "next": obj.get("next"),
            "classifications": [ClassificationSummary.from_dict(_item) for _item in obj["classifications"]] if obj.get("classifications") is not None else None
        })
        return _obj
