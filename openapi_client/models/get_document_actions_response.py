...
class GetDocumentActionsResponse(BaseModel):
    """
    GetDocumentActionsResponse
    """ # noqa: E501
    next: Optional[StrictStr] = Field(default=None, description="Next page of results token")
    actions: Optional[List[DocumentAction]] = Field(default=None, description="List of document actions")
    __properties: ClassVar[List[str]] = ["next", "actions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "next": obj.get("next"),
            "actions": [DocumentAction.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None
        })
        return _obj
