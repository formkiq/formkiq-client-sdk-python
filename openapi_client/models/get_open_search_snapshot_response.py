...
class GetOpenSearchSnapshotResponse(BaseModel):
    """
    GetOpenSearchSnapshotResponse
    """ # noqa: E501
    snapshots: Optional[List[OpenSearchSnapshot]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "snapshots": [OpenSearchSnapshot.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None
        })
        return _obj
