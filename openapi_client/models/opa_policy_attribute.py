...
class OpaPolicyAttribute(BaseModel):
    ...
    var_in: Optional[OpaPolicyAttributeIn] = Field(default=None, alias="in")
    not_in: Optional[OpaPolicyAttributeNotIn] = Field(default=None, alias="notIn")
    __properties: ClassVar[List[str]] = ["key", "eq", "gt", "gte", "lt", "lte", "neq", "in", "notIn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "in": OpaPolicyAttributeIn.from_dict(obj["in"]) if obj.get("in") is not None else None,
            "notIn": OpaPolicyAttributeNotIn.from_dict(obj["notIn"]) if obj.get("notIn") is not None else None
        })
        return _obj
