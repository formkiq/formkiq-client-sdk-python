...
class SetSchemaAttributes(BaseModel):
    """
    SetSchemaAttributes
    """ # noqa: E501
    ...
    required: Optional[List[AddAttributeSchemaRequired]] = Field(default=None, description="List of Required Attributes")
    optional: Optional[List[AddAttributeSchemaOptional]] = Field(default=None, description="List of Optional Attribute")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "required": [AddAttributeSchemaRequired.from_dict(_item) for _item in obj["required"]] if obj.get("required") is not None else None,
            "optional": [AddAttributeSchemaOptional.from_dict(_item) for _item in obj["optional"]] if obj.get("optional") is not None else None,
