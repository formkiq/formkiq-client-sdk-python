...
class Task(BaseModel):
    ...
    planned_start_date: Optional[StrictStr] = Field(default=None, description="Planned Start Date of Task", alias="plannedStartDate")
    ...
    due_date: Optional[StrictStr] = Field(default=None, description="Due Date of Task", alias="dueDate")
    user_id: Optional[StrictStr] = Field(default=None, description="User who added Task", alias="userId")
    status: Optional[TaskStatus] = None
    metadata: Optional[Dict[str, Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["taskId", "insertedDate", "name", "description", "plannedStartDate", "startDate", "endDate", "dueDate", "userId", "status", "metadata"]
