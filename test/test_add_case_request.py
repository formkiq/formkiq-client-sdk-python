...
class TestAddCaseRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddCaseRequest:
        """Test AddCaseRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddCaseRequest`
        """
        ...
        if include_optional:
            return AddCaseRequest(
                case = formkiq_client.models.add_case.AddCase(
                    ...
                    tasks = [
                        formkiq_client.models.add_task.AddTask(
                            description = '', )
                        ], 
                    nigos = [
                        formkiq_client.models.add_nigo.AddNigo(
                            description = '', )
                        ], )
            )
        else:
