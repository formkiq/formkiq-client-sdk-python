...
class TestAddChildDocument(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddChildDocument:
        """Test AddChildDocument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddChildDocument`
        """
        model = AddChildDocument()
        if include_optional:
