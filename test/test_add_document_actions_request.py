...
class TestAddDocumentActionsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddDocumentActionsRequest:
        """Test AddDocumentActionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddDocumentActionsRequest`
        """
        model = AddDocumentActionsRequest()
        if include_optional:
    ...
    def testAddDocumentActionsRequest(self):
        """Test AddDocumentActionsRequest"""
