...
class TestAddDocumentGenerateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddDocumentGenerateRequest:
        """Test AddDocumentGenerateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddDocumentGenerateRequest`
        """
        model = AddDocumentGenerateRequest()
        if include_optional:
            return AddDocumentGenerateRequest(
                locale = formkiq_client.models.locale.Locale(
                    language = '', 
                    country = '', ),
                datasources = [
    ...
    def testAddDocumentGenerateRequest(self):
        """Test AddDocumentGenerateRequest"""
