...
class TestAddDocumentOcrRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddDocumentOcrRequest:
        """Test AddDocumentOcrRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddDocumentOcrRequest`
        """
        model = AddDocumentOcrRequest()
        if include_optional:
    ...
    def testAddDocumentOcrRequest(self):
        """Test AddDocumentOcrRequest"""
