...
class TestAddDocumentResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddDocumentResponse:
        """Test AddDocumentResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddDocumentResponse`
        """
        model = AddDocumentResponse()
        if include_optional:
    ...
    def testAddDocumentResponse(self):
        """Test AddDocumentResponse"""
