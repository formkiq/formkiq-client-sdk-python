...
class TestAddDocumentTagsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddDocumentTagsRequest:
        """Test AddDocumentTagsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddDocumentTagsRequest`
        """
        model = AddDocumentTagsRequest()
        if include_optional:
    ...
    def testAddDocumentTagsRequest(self):
        """Test AddDocumentTagsRequest"""
