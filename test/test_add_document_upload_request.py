...
class TestAddDocumentUploadRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddDocumentUploadRequest:
        """Test AddDocumentUploadRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddDocumentUploadRequest`
        """
        model = AddDocumentUploadRequest()
        if include_optional:
            return AddDocumentUploadRequest(
                document_id = '',
                path = '',
                content_type = '',
                width = '',
    ...
    def testAddDocumentUploadRequest(self):
        """Test AddDocumentUploadRequest"""
