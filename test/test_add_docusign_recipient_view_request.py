...
class TestAddDocusignRecipientViewRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddDocusignRecipientViewRequest:
        """Test AddDocusignRecipientViewRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddDocusignRecipientViewRequest`
        """
        model = AddDocusignRecipientViewRequest()
        if include_optional:
    ...
    def testAddDocusignRecipientViewRequest(self):
        """Test AddDocusignRecipientViewRequest"""
