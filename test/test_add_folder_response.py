...
class TestAddFolderResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddFolderResponse:
        """Test AddFolderResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddFolderResponse`
        """
    ...
    def testAddFolderResponse(self):
        """Test AddFolderResponse"""
