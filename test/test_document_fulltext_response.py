...
class TestDocumentFulltextResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentFulltextResponse:
        """Test DocumentFulltextResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentFulltextResponse`
        """
        model = DocumentFulltextResponse()
        if include_optional:
    ...
    def testDocumentFulltextResponse(self):
        """Test DocumentFulltextResponse"""
