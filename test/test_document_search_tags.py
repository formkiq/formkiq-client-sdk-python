...
class TestDocumentSearchTags(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentSearchTags:
        """Test DocumentSearchTags
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentSearchTags`
        """
        model = DocumentSearchTags()
        if include_optional:
    ...
    def testDocumentSearchTags(self):
        """Test DocumentSearchTags"""
