...
class TestDocumentSharesApi(unittest.TestCase):
    """DocumentSharesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DocumentSharesApi()

    def tearDown(self) -> None:
        pass

    def test_add_folder_share(self) -> None:
        """Test case for add_folder_share
    ...
    def test_get_user_shares(self) -> None:
