...
class TestFulltextSearchItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FulltextSearchItem:
        """Test FulltextSearchItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FulltextSearchItem`
        """
        model = FulltextSearchItem()
        if include_optional:
    ...
    def testFulltextSearchItem(self):
        """Test FulltextSearchItem"""
