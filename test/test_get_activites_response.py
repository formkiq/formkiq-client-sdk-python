...
class TestGetActivitesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetActivitesResponse:
        """Test GetActivitesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetActivitesResponse`
        """
        model = GetActivitesResponse()
        if include_optional:
    ...
    def testGetActivitesResponse(self):
        """Test GetActivitesResponse"""
