...
class TestGetCaseDocumentsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCaseDocumentsResponse:
        """Test GetCaseDocumentsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCaseDocumentsResponse`
        """
        model = GetCaseDocumentsResponse()
        if include_optional:
    ...
    def testGetCaseDocumentsResponse(self):
        """Test GetCaseDocumentsResponse"""
