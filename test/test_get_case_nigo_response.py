...
class TestGetCaseNigoResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCaseNigoResponse:
        """Test GetCaseNigoResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCaseNigoResponse`
        """
    ...
    def testGetCaseNigoResponse(self):
        """Test GetCaseNigoResponse"""
