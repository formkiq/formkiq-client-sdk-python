...
class TestGetCaseTasksResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCaseTasksResponse:
        """Test GetCaseTasksResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCaseTasksResponse`
        """
        model = GetCaseTasksResponse()
        if include_optional:
    ...
    def testGetCaseTasksResponse(self):
        """Test GetCaseTasksResponse"""
