...
class TestGetClassificationsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetClassificationsResponse:
        """Test GetClassificationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetClassificationsResponse`
        """
        model = GetClassificationsResponse()
        if include_optional:
    ...
    def testGetClassificationsResponse(self):
        """Test GetClassificationsResponse"""
