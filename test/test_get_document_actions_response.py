...
class TestGetDocumentActionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetDocumentActionsResponse:
        """Test GetDocumentActionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDocumentActionsResponse`
        """
        model = GetDocumentActionsResponse()
        if include_optional:
    ...
    def testGetDocumentActionsResponse(self):
        """Test GetDocumentActionsResponse"""
