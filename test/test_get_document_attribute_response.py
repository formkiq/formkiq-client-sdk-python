...
class TestGetDocumentAttributeResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetDocumentAttributeResponse:
        """Test GetDocumentAttributeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDocumentAttributeResponse`
        """
    ...
    def testGetDocumentAttributeResponse(self):
        """Test GetDocumentAttributeResponse"""
