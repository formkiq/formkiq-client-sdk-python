...
class TestGetDocumentAttributesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetDocumentAttributesResponse:
        """Test GetDocumentAttributesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDocumentAttributesResponse`
        """
        model = GetDocumentAttributesResponse()
        if include_optional:
    ...
    def testGetDocumentAttributesResponse(self):
        """Test GetDocumentAttributesResponse"""
