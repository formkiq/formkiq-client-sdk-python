...
class TestGetDocumentDataClassificationResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetDocumentDataClassificationResponse:
        """Test GetDocumentDataClassificationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDocumentDataClassificationResponse`
        """
        model = GetDocumentDataClassificationResponse()
        if include_optional:
    ...
    def testGetDocumentDataClassificationResponse(self):
        """Test GetDocumentDataClassificationResponse"""
