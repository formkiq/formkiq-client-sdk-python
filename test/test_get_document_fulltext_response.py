...
class TestGetDocumentFulltextResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetDocumentFulltextResponse:
        """Test GetDocumentFulltextResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDocumentFulltextResponse`
        """
        model = GetDocumentFulltextResponse()
        if include_optional:
    ...
    def testGetDocumentFulltextResponse(self):
        """Test GetDocumentFulltextResponse"""
