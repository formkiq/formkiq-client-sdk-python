...
class TestGetDocumentTagsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetDocumentTagsResponse:
        """Test GetDocumentTagsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDocumentTagsResponse`
        """
        model = GetDocumentTagsResponse()
        if include_optional:
    ...
    def testGetDocumentTagsResponse(self):
        """Test GetDocumentTagsResponse"""
