...
class TestGetDocumentVersionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetDocumentVersionsResponse:
        """Test GetDocumentVersionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDocumentVersionsResponse`
        """
        model = GetDocumentVersionsResponse()
        if include_optional:
    ...
    def testGetDocumentVersionsResponse(self):
        """Test GetDocumentVersionsResponse"""
