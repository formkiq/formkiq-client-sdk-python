...
class TestGetEntitiesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetEntitiesResponse:
        """Test GetEntitiesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEntitiesResponse`
        """
        model = GetEntitiesResponse()
        if include_optional:
    ...
    def testGetEntitiesResponse(self):
        """Test GetEntitiesResponse"""
