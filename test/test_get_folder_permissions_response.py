...
class TestGetFolderPermissionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFolderPermissionsResponse:
        """Test GetFolderPermissionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFolderPermissionsResponse`
        """
        model = GetFolderPermissionsResponse()
        if include_optional:
    ...
    def testGetFolderPermissionsResponse(self):
        """Test GetFolderPermissionsResponse"""
