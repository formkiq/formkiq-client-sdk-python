...
class TestGetOpaAccessPoliciesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetOpaAccessPoliciesResponse:
        """Test GetOpaAccessPoliciesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOpaAccessPoliciesResponse`
        """
        model = GetOpaAccessPoliciesResponse()
        if include_optional:
    ...
    def testGetOpaAccessPoliciesResponse(self):
        """Test GetOpaAccessPoliciesResponse"""
