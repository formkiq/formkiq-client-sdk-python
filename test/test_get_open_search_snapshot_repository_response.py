...
class TestGetOpenSearchSnapshotRepositoryResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetOpenSearchSnapshotRepositoryResponse:
        """Test GetOpenSearchSnapshotRepositoryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOpenSearchSnapshotRepositoryResponse`
        """
        model = GetOpenSearchSnapshotRepositoryResponse()
        if include_optional:
    ...
    def testGetOpenSearchSnapshotRepositoryResponse(self):
        """Test GetOpenSearchSnapshotRepositoryResponse"""
