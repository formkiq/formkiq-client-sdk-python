...
class TestGetQueuesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetQueuesResponse:
        """Test GetQueuesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetQueuesResponse`
        """
        model = GetQueuesResponse()
        if include_optional:
    ...
    def testGetQueuesResponse(self):
        """Test GetQueuesResponse"""
