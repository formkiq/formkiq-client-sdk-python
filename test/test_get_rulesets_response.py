...
class TestGetRulesetsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetRulesetsResponse:
        """Test GetRulesetsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRulesetsResponse`
        """
        model = GetRulesetsResponse()
        if include_optional:
    ...
    def testGetRulesetsResponse(self):
        """Test GetRulesetsResponse"""
