...
class TestGetSitesSchemaResponse(unittest.TestCase):
    """GetSitesSchemaResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSitesSchemaResponse:
        """Test GetSitesSchemaResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSitesSchemaResponse`
        """
        model = GetSitesSchemaResponse()
        if include_optional:
    ...
    def testGetSitesSchemaResponse(self):
        """Test GetSitesSchemaResponse"""
