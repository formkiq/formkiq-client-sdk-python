...
class TestGetUserSharesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetUserSharesResponse:
        """Test GetUserSharesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserSharesResponse`
        """
        model = GetUserSharesResponse()
        if include_optional:
    ...
    def testGetUserSharesResponse(self):
        """Test GetUserSharesResponse"""
