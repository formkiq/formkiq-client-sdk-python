...
class TestGetUsersInGroupResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetUsersInGroupResponse:
        """Test GetUsersInGroupResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUsersInGroupResponse`
        """
        model = GetUsersInGroupResponse()
        if include_optional:
    ...
    def testGetUsersInGroupResponse(self):
        """Test GetUsersInGroupResponse"""
