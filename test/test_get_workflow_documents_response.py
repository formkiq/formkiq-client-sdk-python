...
class TestGetWorkflowDocumentsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWorkflowDocumentsResponse:
        """Test GetWorkflowDocumentsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkflowDocumentsResponse`
        """
        model = GetWorkflowDocumentsResponse()
        if include_optional:
    ...
    def testGetWorkflowDocumentsResponse(self):
        """Test GetWorkflowDocumentsResponse"""
