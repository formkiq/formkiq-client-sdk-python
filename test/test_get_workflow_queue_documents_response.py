...
class TestGetWorkflowQueueDocumentsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWorkflowQueueDocumentsResponse:
        """Test GetWorkflowQueueDocumentsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkflowQueueDocumentsResponse`
        """
        model = GetWorkflowQueueDocumentsResponse()
        if include_optional:
    ...
    def testGetWorkflowQueueDocumentsResponse(self):
        """Test GetWorkflowQueueDocumentsResponse"""
