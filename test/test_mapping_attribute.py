...
class TestMappingAttribute(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MappingAttribute:
        """Test MappingAttribute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MappingAttribute`
        """
        model = MappingAttribute()
        if include_optional:
