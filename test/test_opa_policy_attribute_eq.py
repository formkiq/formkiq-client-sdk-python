...
class TestOpaPolicyAttributeEq(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OpaPolicyAttributeEq:
        """Test OpaPolicyAttributeEq
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpaPolicyAttributeEq`
        """
        model = OpaPolicyAttributeEq()
        if include_optional:
            return OpaPolicyAttributeEq(
                string_value = '',
                number_value = 1.337,
                boolean_value = True,
    ...
    def testOpaPolicyAttributeEq(self):
        """Test OpaPolicyAttributeEq"""
