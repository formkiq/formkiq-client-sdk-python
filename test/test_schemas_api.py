...
class TestSchemasApi(unittest.TestCase):
    ...
    def test_get_classification_attribute_allowed_values(self) -> None:
        """Test case for get_classification_attribute_allowed_values
    ...
    def test_get_sites_schema_attribute_allowed_values(self) -> None:
        """Test case for get_sites_schema_attribute_allowed_values
