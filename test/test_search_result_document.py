...
class TestSearchResultDocument(unittest.TestCase):
    """SearchResultDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchResultDocument:
        """Test SearchResultDocument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchResultDocument`
        """
        model = SearchResultDocument()
        if include_optional:
    ...
    def testSearchResultDocument(self):
        """Test SearchResultDocument"""
