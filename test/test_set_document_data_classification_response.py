...
class TestSetDocumentDataClassificationResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SetDocumentDataClassificationResponse:
        """Test SetDocumentDataClassificationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetDocumentDataClassificationResponse`
        """
        model = SetDocumentDataClassificationResponse()
        if include_optional:
    ...
    def testSetDocumentDataClassificationResponse(self):
        """Test SetDocumentDataClassificationResponse"""
