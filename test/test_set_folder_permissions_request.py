...
class TestSetFolderPermissionsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SetFolderPermissionsRequest:
        """Test SetFolderPermissionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetFolderPermissionsRequest`
        """
        model = SetFolderPermissionsRequest()
        if include_optional:
    ...
    def testSetFolderPermissionsRequest(self):
        """Test SetFolderPermissionsRequest"""
