...
class TestSetSchemaAttributes(unittest.TestCase):
    """SetSchemaAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetSchemaAttributes:
        """Test SetSchemaAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetSchemaAttributes`
        """
        model = SetSchemaAttributes()
        if include_optional:
    ...
    def testSetSchemaAttributes(self):
        """Test SetSchemaAttributes"""
