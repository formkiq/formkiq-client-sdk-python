...
class TestUpdateDocumentFulltextRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateDocumentFulltextRequest:
        """Test UpdateDocumentFulltextRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDocumentFulltextRequest`
        """
        model = UpdateDocumentFulltextRequest()
        if include_optional:
            return UpdateDocumentFulltextRequest(
                content_type = '',
                content = '',
                content_urls = [
                    ''
    ...
    def testUpdateDocumentFulltextRequest(self):
        """Test UpdateDocumentFulltextRequest"""
