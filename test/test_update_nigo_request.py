...
class TestUpdateNigoRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateNigoRequest:
        """Test UpdateNigoRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateNigoRequest`
        """
    ...
    def testUpdateNigoRequest(self):
        """Test UpdateNigoRequest"""
