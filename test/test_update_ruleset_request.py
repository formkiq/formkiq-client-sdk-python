...
class TestUpdateRulesetRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateRulesetRequest:
        """Test UpdateRulesetRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateRulesetRequest`
        """
    ...
    def testUpdateRulesetRequest(self):
        """Test UpdateRulesetRequest"""
