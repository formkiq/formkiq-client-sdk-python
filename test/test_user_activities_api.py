...
class TestUserActivitiesApi(unittest.TestCase):
    """UserActivitiesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = UserActivitiesApi()

    def tearDown(self) -> None:
        pass

    def test_get_document_user_activities(self) -> None:
        """Test case for get_document_user_activities

        Get user activities for a document
        """
        pass

    def test_get_resource_activities(self) -> None:
        """Test case for get_resource_activities
