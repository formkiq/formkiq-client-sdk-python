...
class TestValidationErrorsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ValidationErrorsResponse:
        """Test ValidationErrorsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidationErrorsResponse`
        """
        model = ValidationErrorsResponse()
        if include_optional:
    ...
    def testValidationErrorsResponse(self):
        """Test ValidationErrorsResponse"""
